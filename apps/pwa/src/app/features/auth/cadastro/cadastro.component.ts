...
@Component({
  ...
  template: `
    <section class="page" aria-labelledby="cadastro-titulo">
      ...
      <form [formGroup]="form" (ngSubmit)="registrar()" novalidate aria-label="Formulário de cadastro">
...
export class CadastroComponent implements OnInit {
  ...
  protected readonly form = this.fb.group({
    address: [
      '',
      [Validators.required, Validators.pattern(this.BITCOIN_ADDRESS_PATTERN)],
    ],
