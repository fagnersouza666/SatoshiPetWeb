...
**YOU ARE IN: `StoshiPetWeb/polecats/guzzle/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/guzzle
```
...
**Your mail address:** `StoshiPetWeb/polecats/guzzle`
...
1. Announce: "Polecat guzzle, checking in."
2. Run: `gt prime`
