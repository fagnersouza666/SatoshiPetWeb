...
**YOU ARE IN: `StoshiPetWeb/polecats/shiny/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/shiny
```
...
**Your mail address:** `StoshiPetWeb/polecats/shiny`
...
1. Announce: "Polecat shiny, checking in."
2. Run: `gt prime`
