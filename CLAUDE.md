...
**YOU ARE IN: `StoshiPetWeb/polecats/nitro/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/nitro
```
...
**Your mail address:** `StoshiPetWeb/polecats/nitro`
...
1. Announce: "Polecat nitro, checking in."
2. Run: `gt prime`
